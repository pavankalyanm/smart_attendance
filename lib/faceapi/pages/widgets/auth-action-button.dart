...
class _AuthActionButtonState extends State<AuthActionButton> {
  ...
  Future _signUp(context) async {
    ...
    DocumentReference docref= await Firestore.instance.collection('users').document("${globals.uid}");
    Map<String,dynamic> data={"faceid":"1"};
  ...
  Future _signIn(context) async {
    ...
    if (this.predictedUser.user == globals.id) {
      ...
      showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            content: Text('User not authorized!'),
          );
        },
      );
    }
